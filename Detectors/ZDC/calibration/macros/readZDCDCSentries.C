...
// macro to read the ZDC DCS information from CCDB
...
void readZDCDCSentries(long ts = 9999999999000, const char* ccdb = "http://localhost:8080")
{
  ...
  std::unordered_map<o2::dcs::DataPointIdentifier, o2::zdc::ZDCDCSinfo>* m = api.retrieveFromTFileAny<std::unordered_map<o2::dcs::DataPointIdentifier, o2::zdc::ZDCDCSinfo>>("ZDC/DCSDPs", metadata, ts);
  ...
  std::bitset<22>* hv = api.retrieveFromTFileAny<std::bitset<o2::zdc::Geo::NCHANNELS>>("ZDC/HVStatus", metadata, ts);
